...
However, except for the parameter definitions in the simdesign function and hte output of the function, the genetic algorithm optimization (`simdesign_GenAlg()`) works in the same way.
